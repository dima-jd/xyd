...
class Figure {
        constructor(el) {
            ...
            if ( this.DOM.el.classList.contains('slide__figure--main') ) {
                this.isMain = true;
                // Эффект движения main image. 
                //При движении мыши, создает движущиеся клоны изображения.
                // Общее кол-во картинок (main image + clones).
                this.totalTiltImgs = 3;
                ...
                // инициализировать эффект движения.
...
class Slide {
        constructor(el) {
            ...
            //При движении мыши, создает движущиеся клоны заголовка.
            // Общее кол-во (slide__title + clones);
            this.totalTiltText = 5;
